/* =========================================================
   ...
   Painéis: efetivo, cadastros, oficios, viaturas, whatsapp, enquetes, paineis, pontos, usuarios, conta
...
(function () {
  ...
  const BLOQUEIOS = {
    ...
    pontos: { ocultar: "#btn-novo-ponto,[data-acao=editar-ponto],[data-acao=excluir-ponto]", desativar: "" },
  };
